// ------------------------------------------what happened anedhi(functions)---------------------------------------
//so ikkad em jarigindh ante, used functions, look in for more details, all of them are commented out,
//uncomment wot all u wann see
